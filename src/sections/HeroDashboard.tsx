...
export default function HeroDashboard() {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1200px] mx-auto px-3 sm:px-6 py-6 sm:py-12 w-full">
        {/* Two-column on ALL screen sizes: text left, phone right */}
        <div className="grid grid-cols-2 lg:grid-cols-2 gap-3 sm:gap-6 lg:gap-10 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-1.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-2.5 py-1 mb-2 sm:mb-5"
            >
              <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse shrink-0" />
              <span className="text-white/90 text-[10px] sm:text-xs font-medium leading-none">
            ...
            <h1
              className="font-extrabold text-white leading-[1.15] mb-1.5 sm:mb-4"
              style={{ fontSize: "clamp(1.2rem, 5.5vw, 3rem)" }}
            >
              Get Fast,{" "}
            ...
            <p
              className="text-white/65 mb-3 sm:mb-6 leading-relaxed max-w-[440px]"
              style={{ fontSize: "clamp(0.7rem, 2.2vw, 1rem)" }}
            >
              Access up to <span className="text-white font-semibold">$50,000</span> in minutes.
              Low fixed rates, instant approval.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col gap-1.5 sm:flex-row sm:gap-3 mb-3 sm:mb-7">
              <motion.button
                ...
                style={{ fontSize: "clamp(0.65rem, 2.4vw, 0.875rem)", padding: "clamp(0.4rem, 1.4vw, 0.625rem) clamp(0.6rem, 2.2vw, 1.5rem)" }}
              >
                Apply Now — It's Free
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                onClick={openEligibility}
                className="bg-white/10 hover:bg-white/20 border border-white/25 text-white font-semibold rounded-lg sm:rounded-xl transition-colors cursor-pointer backdrop-blur-sm"
                style={{ fontSize: "clamp(0.65rem, 2.4vw, 0.875rem)", padding: "clamp(0.4rem, 1.4vw, 0.625rem) clamp(0.6rem, 2.2vw, 1.5rem)" }}
              >
                Check Eligibility
              </motion.button>
          ...
          >
            ...
            <div className="relative w-[150px] h-[195px] sm:w-[210px] sm:h-[270px] lg:w-[300px] lg:h-[380px]">
              {/* Glow */}
              ...
              <img
                ...
                alt="WAAFI App"
                className="absolute left-1/2 -translate-x-1/2 top-0 rounded-[18px] sm:rounded-[22px] lg:rounded-[28px] shadow-2xl z-10 w-[118px] sm:w-[170px] lg:w-[240px]"
              />
              ...
              <motion.div
                ...
                className="absolute -top-3 -right-3 sm:-top-4 sm:-right-2 z-20"
              >
                <img src="/images/frame10.svg" alt="" className="w-[64px] sm:w-[90px] lg:w-[120px] drop-shadow-lg" />
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute bottom-0 -left-7 sm:-left-7 lg:-left-8 z-20"
              >
                <img src="/images/frame9.svg" alt="" className="w-[58px] sm:w-[80px] lg:w-[110px] drop-shadow-lg" />
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute top-1/2 -right-7 sm:-right-10 lg:-right-12 -translate-y-1/2 z-20"
              >
                <img src="/images/frame8.svg" alt="" className="w-[40px] sm:w-[55px] lg:w-[75px] drop-shadow-lg" />
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute top-4 -left-8 sm:top-8 sm:-left-9 lg:-left-10 z-20"
              >
                <img src="/images/voice.svg" alt="" className="w-[50px] sm:w-[68px] lg:w-[95px] drop-shadow-lg" />
              </motion.div>
            </div>
          </motion.div>
